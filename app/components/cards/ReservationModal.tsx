              ...
              {stepLabels.map((label, i) => (
                <div key={label} className="flex items-center">
                  <div className={`flex items-center gap-2 ${step > i + 1 ? "opacity-50" : ""}`}>
                    ...
                    <span
                      className={`text-[9px] uppercase tracking-[0.2em] transition-colors duration-300 ${step === i + 1 ? "text-[#c9a84c]" : "text-white/20"}`}
                      style={{ fontFamily: "var(--font-cinzel)" }}
                    >
                      {label}
                    </span>
          ...
          <div className="flex-1 overflow-y-auto p-10">
            ...
            {step === 1 && (
              <div>
                ...
                <p className="text-[#d4c5a0]/40 mb-8 text-lg font-light" style={{ fontFamily: "var(--font-cormorant)" }}>
                ...
                <div className="space-y-3">
                  {airships.map((ship) => (
                    ...
                    >
                      <span className="text-[#c9a84c]/25 text-3xl group-hover:text-[#c9a84c]/60 transition-colors font-light w-8" style={{ fontFamily: "var(--font-cinzel)" }}>
                        {ship.icon}
                      </span>
                      <div>
                        <h3 className="text-[#ede0c4] text-xl font-light group-hover:text-[#c9a84c] transition-colors" style={{ fontFamily: "var(--font-cormorant)" }}>
                          {ship.name}
                        </h3>
                        <p className="text-[#d4c5a0]/40 text-sm mt-1 font-light" style={{ fontFamily: "var(--font-cormorant)" }}>
                          {ship.desc}
                        </p>
                      </div>
            ...
            {step === 2 && (
              <div>
                ...
                <button onClick={() => setStep(1)} className="mt-6 text-[#d4c5a0]/30 hover:text-[#c9a84c] transition-colors text-xs tracking-[0.2em] uppercase flex items-center gap-2" style={{ fontFamily: "var(--font-cinzel)" }}>
                  ← Zurück
                </button>
              </div>
            )}
            ...
            {step === 3 && (
              <div>
                ...
                <button onClick={() => setStep(2)} className="w-full mt-3 text-center text-[#d4c5a0]/25 hover:text-[#c9a84c] transition-colors text-xs tracking-[0.2em] uppercase" style={{ fontFamily: "var(--font-cinzel)" }}>
                  ← Sitzplan ändern
                </button>
              </div>
            )}
